...
This current approach will fail if the detection api call fails to generate objectionable content with the adversarial user prompt. we are assuming a successful adversarial prompt will generate objectionable content more often than not, therefore often triggering True
"""
